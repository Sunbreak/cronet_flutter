...
SampleUrlRequestCallback* SampleUrlRequestCallback_Create() {
  return new SampleUrlRequestCallback();
}

void SampleUrlRequestCallback_Destory(SampleUrlRequestCallback* request_callback) {
  delete request_callback;
}

Cronet_UrlRequestCallbackPtr SampleUrlRequestCallback_GetUrlRequestCallback(SampleUrlRequestCallback* request_callback) {
  return request_callback->GetUrlRequestCallback();
}