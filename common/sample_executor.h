...
DART_EXPORT SampleExecutor* SampleExecutor_Create();

DART_EXPORT void SampleExecutor_Destory(SampleExecutor* executor);

DART_EXPORT Cronet_ExecutorPtr SampleExecutor_GetExecutor(SampleExecutor* executor);
