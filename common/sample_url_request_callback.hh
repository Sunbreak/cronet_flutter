...
DART_EXPORT SampleUrlRequestCallback* SampleUrlRequestCallback_Create();

DART_EXPORT void SampleUrlRequestCallback_Destory(SampleUrlRequestCallback* request_callback);

DART_EXPORT Cronet_UrlRequestCallbackPtr SampleUrlRequestCallback_GetUrlRequestCallback(SampleUrlRequestCallback* request_callback);
